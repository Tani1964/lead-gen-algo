...
class LeadGenerator:
    ...
    def search_serpapi(self, keyword: str, location: str = "United States") -> List[Dict]:
        """
    ...
    def search_zenserp(self, keyword: str, location: str = "United States") -> List[Dict]:
        """
    ...
    def search_openstreetmap(self, keyword: str, location: str = "United States") -> List[Dict]:
        """
    ...
    def search_foursquare(self, keyword: str, location: str = "United States", limit: int = 20) -> List[Dict]:
        """
    ...
    def generate_leads(self, keywords: List[str], location: str = "United States", 
                      use_apis: List[str] = None) -> List[Dict]:
        """
        ...
        """
        if use_apis is None:
            use_apis = ['serpapi', 'zenserp', 'dataforseo', 'openstreetmap', 'foursquare']
...
def main():
    ...
    # Example keywords - modify these based on your needs
    keywords = [
        "plumbers near me",
    ...
    apis_to_use = ['openstreetmap', 'serpapi', 'zenserp', 'dataforseo', 'foursquare']
